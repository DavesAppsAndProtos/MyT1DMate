...
class GlucoseForegroundService : Service() {
    ...
    private fun buildNotification(
        ...
        val color = when {
            ...
            valueMmol < critLow         -> 0xFFEF4444.toInt()  // red   — critical low
            valueMmol < warnLow         -> 0xFFF59E0B.toInt()  // amber — warning low
            valueMmol > critHigh        -> 0xFFEF4444.toInt()  // red   — critical high
            valueMmol > warnHigh        -> 0xFFF59E0B.toInt()  // amber — warning high
            else                        -> 0xFF10B981.toInt()  // green — in range
        }
